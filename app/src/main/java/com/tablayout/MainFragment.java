...
import com.tablayout.adapter.MainPagerAdapter;
...
import com.tablayout.fragment.fourth.SyssettingFragment;
...
public class MainFragment extends BaseFragment {
    ...
    private void initContent() {
        ...
        tabFragments.add(SyssettingFragment.newInstance());

        contentAdapter = new MainPagerAdapter(getChildFragmentManager(), tabFragments, tabIndicators);
